...
> また、2026年5月現在、Ollamaで画像生成機能を使用するには、OllamaサーバーとしてAppleシリコンを搭載したMacを使用する必要があるようです。
...
Mocolammaの開発にはこれらの素晴らしい生成AIツールが使用されました。Swiftを含むプログラミングの知識が一切ない自分にとって、生成AIの力がなければこのアプリを完成させることはできなかったでしょう。
